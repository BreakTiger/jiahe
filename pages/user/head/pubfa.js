...
Page({
  ...
  data: {
    ...
    perHaveN: '',
    perHaveS: [
      ["1~2K", "2~3k", "3~4k", "4~5k", "5~6k", "6~7k", "7~8k", "8~9k", "8~10k","10k以上"],
  ...
  teformSubmit: function (e) {
    ...
    if (che.address != '' && che.duty != '' && che.introduce != '' && che.education != '' && che.pay != '' && che.phone != '' && che.experience != '') {
      ...
      wx.request({
        ...
        method: "POST",
        url: app.globalData.hpUrl + 'Position/positionAdd',
        data: {
