...
Page({
  ...
  teformSubmit: function (e) {
    ...
    // console.log(imgbox2);
    // console.log(che);
    if (che.address != '' && che.area != '' && che.branch != '' && che.establish != '' && che.phone != '' && che.principal != '' && che.remark != '' && che.schoolname != '' && che.scope != '' && che.session != '' && che.studentsnum != '' && imgbox.length != 0) {
      ...
      wx.request({
        ...
        method: "POST",
        url: app.globalData.hpUrl + 'School/schoolinfoAdd',
        data: {
        ...
        success: function (res) {
          ...
          for (let i = 0; i < imgbox.length; i++) {
            ...
            wx.uploadFile({
              url: app.globalData.hpUrl + 'School/sliderimageAdd?id=' + id,
              filePath: imgbox[i],
              name: 'files',
              header: {
